...
--      if line:match("%S") then table.insert(authors, line) end
--    end
--    f:close()
--  else
...
--
---- Insert trailer
--local function insert_coauthor()
--  if #authors == 0 then return end
--  vim.ui.select(authors, { prompt = "Pick co-author" }, function(item)
--    if not item then return end
--    vim.api.nvim_put({ "Co-authored-by: " .. item }, "l", true, true)
--  end)
--end
--
